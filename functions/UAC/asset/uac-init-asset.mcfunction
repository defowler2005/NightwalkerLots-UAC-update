...
execute as @s[scores={wbmtoggle=0}] run scoreboard players set @s Border_Coord_X 70000
execute as @s[scores={wbmtoggle=0}] run scoreboard players set @s Border_Coord_Z 70000
